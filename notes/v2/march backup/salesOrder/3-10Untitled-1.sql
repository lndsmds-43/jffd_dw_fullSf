...
FROM OrderSummary 
WHERE NS_Sales_Order_ID__c = ''
  AND Status IN ('Assigned to Store', 'Fulfilled by Store', 'Approved') 
  AND CreatedDate > 2024-06-01T01:24:51.000+0000 
  AND LastModifiedDate > 2024-06-01T01:24:51.000+0000
LIMIT 5

Select Id, Method, CapturedAmount, OrderSummary.batchId__c FROM OrderPaymentSummary WHERE NS_Customer_Deposit_ID__c = null AND CapturedAmount > 0 AND ordersummary.NS_Sales_Order_ID__c = '" ++ vars.nsGETSalesOrderId ++ "'",
